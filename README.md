...
By default, mkosi reads the version of this image from the `mkosi.version` file which contains a script
to generate image version dynamically from datetime and git rev.
...
Copyright Rolo Wilde <git@rolowil.de>
